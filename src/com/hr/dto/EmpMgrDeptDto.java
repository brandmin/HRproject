...
public class EmpMgrDeptDto {
	...
	private DepartmentsDto department_name;
	...
	public EmpMgrDeptDto(Integer employee_id, String first_name, String last_name, String email, String phone_number,
			LocalDateTime hire_date, String job_id, int salary, int commission_pct, Integer manager_id,
			Integer department_id, DepartmentsDto department_name) {
		super();
	...
	public DepartmentsDto getDepartment_name() {
		return department_name;
	}

	public void setDepartment_name(DepartmentsDto department_name) {
		this.department_name = department_name;
	}
