...
public class DepartmentsService {
	...
	public static void insertDB(HttpServletRequest request, HttpServletResponse response) {
		DepartmentsDto dto = new DepartmentsDto(Integer.getInteger(
				request.getParameter("department_id")),
				Integer.getInteger(request.getParameter("location_id")),
				request.getParameter("departmet_name"),
				Integer.getInteger(request.getParameter("manager_id")));
